...
class OSF_Customize_Control_Background_Position extends WP_Customize_Control {
	...
	public function render_content() {
		$options = array(
			array(
				'left top'   => array(
					'label' => __( 'Top Left', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center top' => array(
					'label' => __( 'Top', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-up-alt'
				),
				'right top'  => array(
					'label' => __( 'Top Right', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left center'   => array(
					'label' => __( 'Left', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center center' => array(
				...
				'right center'  => array(
					'label' => __( 'Right', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left bottom'   => array(
					'label' => __( 'Bottom Left', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center bottom' => array(
					'label' => __( 'Bottom', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-down-alt'
				),
				'right bottom'  => array(
					'label' => __( 'Bottom Right', 'editech-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
		);
