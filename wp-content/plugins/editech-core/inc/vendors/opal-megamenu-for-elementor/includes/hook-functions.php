...
add_action( 'elementor/widgets/widgets_registered', "osf_include_single_widgets" );
...
function osf_add_back_button_inspector() {
    ...
    <script type="text/template" id="tmpl-elementor-panel-footer-content">
        <div id="elementor-panel-footer-back-to-admin" class="elementor-panel-footer-tool elementor-leave-open tooltip-target" data-tooltip="<?php esc_attr_e( 'Back', 'editech-core' ); ?>">
            <i class="fa fa-arrow-left" aria-hidden="true"></i>
        </div>
        <div id="elementor-panel-footer-responsive" class="elementor-panel-footer-tool">
            <i class="eicon-device-desktop tooltip-target" aria-hidden="true" data-tooltip="<?php esc_attr_e( 'Responsive Mode', 'editech-core' ); ?>"></i>
            <span class="elementor-screen-only">
					<?php echo __( 'Responsive Mode', 'editech-core' ); ?>
				</span>
            <div class="elementor-panel-footer-sub-menu-wrapper">
                <div class="elementor-panel-footer-sub-menu">
                    <div class="elementor-panel-footer-sub-menu-item" data-device-mode="desktop">
                        ...
                        <span class="elementor-title"><?php echo __( 'Desktop', 'editech-core' ); ?></span>
                        <span class="elementor-description"><?php echo __( 'Default Preview', 'editech-core' ); ?></span>
                    </div>
                    <div class="elementor-panel-footer-sub-menu-item" data-device-mode="tablet">
                        ...
                        <span class="elementor-title"><?php echo __( 'Tablet', 'editech-core' ); ?></span>
						<?php $breakpoints = Elementor\Core\Responsive\Responsive::get_breakpoints(); ?>
                        <span class="elementor-description"><?php echo sprintf( __( 'Preview for %s', 'editech-core' ), $breakpoints['md'] . 'px' ); ?></span>
                    </div>
                    <div class="elementor-panel-footer-sub-menu-item" data-device-mode="mobile">
                        ...
                        <span class="elementor-title"><?php echo __( 'Mobile', 'editech-core' ); ?></span>
                        <span class="elementor-description"><?php echo __( 'Preview for 360px', 'editech-core' ); ?></span>
                    </div>
                </div>
            </div>
        </div>
        <div id="elementor-panel-footer-history" class="elementor-panel-footer-tool elementor-leave-open tooltip-target" data-tooltip="<?php esc_attr_e( 'History', 'editech-core' ); ?>">
            <i class="fa fa-history" aria-hidden="true"></i>
            <span class="elementor-screen-only"><?php echo __( 'History', 'editech-core' ); ?></span>
        </div>
        <div id="elementor-panel-saver-button-preview" class="elementor-panel-footer-tool tooltip-target" data-tooltip="<?php esc_attr_e( 'Preview Changes', 'editech-core' ); ?>">
				<span id="elementor-panel-saver-button-preview-label">
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="elementor-screen-only"><?php echo __( 'Preview Changes', 'editech-core' ); ?></span>
				</span>
        </div>
        <div id="elementor-panel-saver-publish" class="elementor-panel-footer-tool">
            <button id="elementor-panel-saver-button-publish" class="elementor-button elementor-button-success elementor-saver-disabled">
                ...
                <span id="elementor-panel-saver-button-publish-label">
						<?php echo __( 'Publish', 'editech-core' ); ?>
					</span>
            </button>
        </div>
        <div id="elementor-panel-saver-save-options" class="elementor-panel-footer-tool">
            <button id="elementor-panel-saver-button-save-options" class="elementor-button elementor-button-success tooltip-target elementor-saver-disabled" data-tooltip="<?php esc_attr_e( 'Save Options', 'editech-core' ); ?>">
                <i class="fa fa-caret-up" aria-hidden="true"></i>
                <span class="elementor-screen-only"><?php echo __( 'Save Options', 'editech-core' ); ?></span>
            </button>
            <div class="elementor-panel-footer-sub-menu-wrapper">
                ...
                <div class="elementor-panel-footer-sub-menu">
                    <div id="elementor-panel-saver-menu-save-draft" class="elementor-panel-footer-sub-menu-item elementor-saver-disabled">
                        ...
                        <span class="elementor-title"><?php echo __( 'Save Draft', 'editech-core' ); ?></span>
                    </div>
                    <div id="elementor-panel-saver-menu-save-template" class="elementor-panel-footer-sub-menu-item">
                        ...
                        <span class="elementor-title"><?php echo __( 'Save as Template', 'editech-core' ); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
function osf_load_menu_data() {
	...
	if ( ! wp_verify_nonce( $nonce, 'osf-menu-data-nonce' ) || ! $menu_id ) {
		wp_send_json( array(
			'message' => __( 'Access denied', 'editech-core' )
		) );
	}
                    ...
                    <form id="menu-edit-form">
                        ...
                        <div class="osf-modal-content">
                            ...
                            <div class="form-group">
                                <label for="icon_color"><?php _e( 'Menu Description', 'editech-core' ) ?></label>
                                <input type="text" name="opal-menu-item[description]" value="<%= data.description %>" class="input" id="menu_description"/>
                            </div>
                            <div class="form-group">
                                <label for="icon"><?php _e( 'Icon', 'editech-core' ) ?></label>
                            ...
                            <div class="form-group submenu-setting toggle-select-setting">
                                <label><?php _e( 'Mega Submenu Enabled', 'editech-core' ) ?></label>
                                <select name="opal-menu-item[enabled]" class="opal-input-switcher opal-input-switcher-true" data-target=".submenu-width-setting">
                                    ...
                                    %>> <?php _e( 'Yes', 'editech-core' ) ?></opttion>
                                    <option value="0"
                                    <%= data.enabled == 0? 'selected':'' %>><?php _e( 'No', 'editech-core' ) ?></opttion>
                                </select>
                                <button id="edit-megamenu" class="button button-primary button-large">
									<?php _e( 'Edit Megamenu Submenu', 'editech-core' ) ?>
                                </button>
                            </div>

                            <div class="form-group submenu-width-setting toggle-select-setting" style="display: none">
                                <label><?php _e( 'Sub Megamenu Width', 'editech-core' ) ?></label>
                                <select name="opal-menu-item[customwidth]" class="opal-input-switcher opal-input-switcher-true" data-target=".submenu-subwidth-setting">
                                    ...
                                    %>><?php _e( 'Set Container Width', 'editech-core' ) ?></opttion>
                                    <option value="0"
                                    <%= data.customwidth == 0? 'selected':''
                                    %>><?php _e( 'Set Full Width', 'editech-core' ) ?></opttion>
                                    <option value="2"
                                    <%= data.customwidth == 2? 'selected':''
                                    %>><?php _e( 'Set Stretch Width', 'editech-core' ) ?></opttion>
                                    <option value="4"
                                    <%= data.customwidth == 4? 'selected':''
                                    %>><?php _e( 'Set Left Full Width', 'editech-core' ) ?></opttion>
                                </select>
                            </div>

                            <div class="form-group submenu-width-setting submenu-subwidth-setting toggle-select-setting" style="display: none">
                                <label for="menu_subwidth"><?php _e( 'Sub Mega Menu Max Width', 'editech-core' ) ?></label>
