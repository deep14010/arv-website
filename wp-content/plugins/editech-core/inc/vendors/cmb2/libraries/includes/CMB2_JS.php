...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'editech-core' ),
			'defaultString' => esc_html__( 'Default', 'editech-core' ),
			'pick'          => esc_html__( 'Select Color', 'editech-core' ),
			'current'       => esc_html__( 'Current Color', 'editech-core' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'editech-core' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'editech-core' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'editech-core' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'editech-core' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'editech-core' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'editech-core' ) ),
					'nextText'        => esc_html__( 'Next', 'editech-core' ),
					'prevText'        => esc_html__( 'Prev', 'editech-core' ),
					'currentText'     => esc_html__( 'Today', 'editech-core' ),
					'closeText'       => esc_html__( 'Done', 'editech-core' ),
					'clearText'       => esc_html__( 'Clear', 'editech-core' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'editech-core' ),
					'timeText'      => esc_html__( 'Time', 'editech-core' ),
					'hourText'      => esc_html__( 'Hour', 'editech-core' ),
					'minuteText'    => esc_html__( 'Minute', 'editech-core' ),
					'secondText'    => esc_html__( 'Second', 'editech-core' ),
					'currentText'   => esc_html__( 'Now', 'editech-core' ),
					'closeText'     => esc_html__( 'Done', 'editech-core' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'editech-core' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'editech-core' ),
				'upload_files' => esc_html__( 'Use these files', 'editech-core' ),
				'remove_image' => esc_html__( 'Remove Image', 'editech-core' ),
				'remove_file'  => esc_html__( 'Remove', 'editech-core' ),
				'file'         => esc_html__( 'File:', 'editech-core' ),
				'download'     => esc_html__( 'Download', 'editech-core' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'editech-core' ),
			),
		);
