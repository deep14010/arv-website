...
class  OSF_Elementor_Heading extends Widget_Heading {
    ...
    public function get_title() {
        return __('Opal Heading', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('Add Your Heading Text Here', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Enter your subtitle', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small'   => __('Small', 'editech-core'),
                    'medium'  => __('Medium', 'editech-core'),
                    'large'   => __('Large', 'editech-core'),
                    'xl'      => __('XL', 'editech-core'),
                    'xxl'     => __('XXL', 'editech-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'header_size',
            [
                'label'   => __('HTML Tag', 'editech-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'h1'   => 'H1',
                    'h2'   => 'H2',
