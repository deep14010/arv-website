...
class OSF_Elementor_Testimonials extends OSF_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return __('Opal Testimonials', 'editech-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'testimonial_name'    => __('Testimonial #1', 'editech-core'),
                        'testimonial_job'     => __('Design', 'editech-core'),
                        'testimonial_content' => __('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                        'testimonial_image'   => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
                        ],
                    ],
                    [
                        'testimonial_name'    => __('Testimonial #2', 'editech-core'),
                        'testimonial_job'     => __('Design', 'editech-core'),
                        'testimonial_content' => __('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                        'testimonial_image'   => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
                    ...
                    [
                        'testimonial_name'    => __('Testimonial #3', 'editech-core'),
                        'testimonial_job'     => __('Design', 'editech-core'),
                        'testimonial_content' => __('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                        'testimonial_image'   => [
                            'url' => Elementor\Utils::get_placeholder_image_src()
        ...
        $this->add_control(
            ...
            [
                'label'          => __('Image Position', 'editech-core'),
                'type'           => Controls_Manager::SELECT,
                'default'        => 'aside',
                'options'        => [
                    'above' => __('Above', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'layout_1',
                'options' => [
                    'layout_1' => __('Layout 1', 'editech-core'),
                    'layout_2' => __('Layout 2', 'editech-core'),
                ],
            ]
        );
        $this->add_control(
                        ...
                        <div <?php echo $this->get_render_attribute_string('item'); ?>>
                            <?php if ($settings['testimonial_layout'] == 'layout_1'): ?>
                                ...
                                <div class="item-box">
                                    ...
                                    <?php if ($settings['testimonial_image_position'] == 'above' && $has_image) : ?>
                                        <div class="elementor-testimonial-meta ">

                                            <div class="elementor-testimonial-meta-inner"><?php $this->render_image($settings, $testimonial) ?></div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (($settings['testimonial_image_position'] != 'above' && $has_image) || $has_name || $has_job) : ?>
                                        <div <?php echo $this->get_render_attribute_string('meta'); ?>>
                                            <div class="elementor-testimonial-meta-inner">

                                                <?php if (($settings['testimonial_image_position'] != 'above' && $has_image)) $this->render_image($settings, $testimonial); ?>
