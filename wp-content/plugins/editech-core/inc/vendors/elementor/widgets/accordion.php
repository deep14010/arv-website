...
class OSF_Elementor_Widget_Accordion extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Accordion', 'editech-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_title',
            [
                'label' => __( 'Accordion', 'editech-core' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Title', 'editech-core' ),
                'dynamic' => [
                    'active' => true,
                ],
                'label_block' => true,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Accordion Content', 'editech-core' ),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label' => __( 'Accordion Items', 'editech-core' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => __( 'Accordion #1', 'editech-core' ),
                        'tab_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core' ),
                    ],
                    [
                        'tab_title' => __( 'Accordion #2', 'editech-core' ),
                        'tab_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Active Icon', 'editech-core' ),
                'type' => Controls_Manager::ICONS,
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'left' => [
                        'title' => __( 'Start', 'editech-core' ),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'right' => [
                        'title' => __( 'End', 'editech-core' ),
