...
class OSF_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Team Box', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => __('Team Item', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('https://www.facebook.com/opalwordpress', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('https://twitter.com/opalwordpress', 'editech-core'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => __('Youtube', 'editech-core'),
                'placeholder' => __('https://www.youtube.com/user/WPOpalTheme', 'editech-core'),
        ...
        $this->add_control(
            'google',
            [
                'label'       => __('Google', 'editech-core'),
                'placeholder' => __('https://plus.google.com/u/0/+WPOpal', 'editech-core'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Icon Social', 'editech-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
