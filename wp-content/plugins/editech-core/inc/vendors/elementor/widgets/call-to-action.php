...
class OSF_Elementor_CallToAction extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Call to Action', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __('Image Resolution', 'editech-core'),
                'default'   => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label'       => __('Graphic Element', 'editech-core'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'none'  => [
                        'title' => __('None', 'editech-core'),
                        'icon'  => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => __('Image', 'editech-core'),
                        'icon'  => 'eicon-image',
                    ],
                    'icon'  => [
                        'title' => __('Icon', 'editech-core'),
                        'icon'  => 'eicon-star',
                    ],
                ],
                'separator'   => 'before',
        ...
        $this->add_control(
            'status_text',
            [
                'label'       => __('Status Text', 'editech-core'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your text', 'editech-core'),
                'label_block' => true,
                'condition'   => [
                    'icon_view' => 'default'
                ],
        ...
        $this->add_control(
            'title',
            [
                'label'       => __('Title & Description', 'editech-core'),
                'type'        => Controls_Manager::TEXT,
        ...
        $this->add_responsive_control(
            'title_width',
            [
                'label'      => __('Max Width', 'editech-core'),
        ...
        $this->add_control(
            'title_reverse',
            [
                'label'        => __('Title Reverse', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'editech-core'),
        ...
        $this->add_control(
            'link_click',
            [
                'label'     => __('Apply Link On', 'editech-core'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'box'    => __('Whole Box', 'editech-core'),
                    'button' => __('Button Only', 'editech-core'),
                ],
                'default'   => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'       => __('Horizontal Position', 'editech-core'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Effect Duration', 'editech-core'),
                'type'      => Controls_Manager::SLIDER,
                'default'   => [
                    'size' => 500,
                ],
        ...
        $this->add_responsive_control(
            'min-height',
            [
                'label'      => __('Min. Height', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_responsive_control(
            'min-height-hover',
            [
                'label'      => __('Min. Height Hover', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            'vertical_position',
            [
                'label'        => __('Vertical Position', 'editech-core'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'options'      => [
                    'top'    => [
        ...
        $this->add_responsive_control(
            'image_min_width',
            [
                'label'      => __('Min. Width', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'icon_padding',
            [
                'label'     => __('Icon Padding', 'editech-core'),
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'status_animated_bg_text',
            [
                'label'        => __('Status Animated BG Text', 'editech-core'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => 'yes',
                'prefix_class' => 'elementor-animated-bg-text-',
                'condition'    => [
                    'status_text!' => '',
                ],
            ]
        ...
        $this->add_control(
            'status_text_color',
            [
                'label'     => __('Status text Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => __('Description Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_color',
            [
                'label'     => __('Button Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'dark'              => __('Dark', 'editech-core'),
                    'light'             => __('Light', 'editech-core'),
                    ...
                    'outline_dark'      => __('Outline Dark', 'editech-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __('Typography', 'editech-core'),
        ...
        $this->start_controls_section(
            'section_icon_style',
            [
                'label'     => __('Icon Button', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'icon!' => '',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'left',
                'options'   => [
                    'left'  => __('Before', 'editech-core'),
                    'right' => __('After', 'editech-core'),
                ],
                'condition' => [
                    'icon_cta!' => '',
                ],
        ...
        $this->add_responsive_control(
            'icon-rotate',
            [
                'label'     => __('Icon Rotate', 'editech-core'),
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->start_controls_section(
            'img_hover_effects',
            [
                'label' => __('Image Hover Effects', 'editech-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'groups'       => [
                    [
                        'label'   => __('None', 'editech-core'),
                        'options' => [
                            '' => __('None', 'editech-core'),
                        ],
                    ],
                    [
                        'label'   => __('Entrance', 'editech-core'),
                        'options' => [
                    ...
                    [
                        'label'   => __('Reaction', 'editech-core'),
                        'options' => [
                            'grow'       => 'Grow',
                            'shrink'     => 'Shrink',
        ...
        $this->add_control(
            'sequenced_animation',
            [
                'label'        => __('Sequenced Animation', 'editech-core'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'overlay_blend_mode',
            [
                'label'     => __('Blend Mode', 'editech-core'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
