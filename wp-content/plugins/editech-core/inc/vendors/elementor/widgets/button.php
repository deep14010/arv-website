    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Click here', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            'button_css_id',
            [
                'label'       => __('Button ID', 'editech-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'title'       => __('Add your custom id WITHOUT the Pound key. e.g: my-id', 'editech-core'),
                'label_block' => false,
                'description' => __('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'editech-core'),
                'separator'   => 'before',
        ...
        $this->start_controls_section(
            'contactform7',
            [
                'label' => __('Contact Form Popup', 'editech-core'),
            ]
        );
        $cf7 = get_posts('post_type="wpcf7_contact_form"&numberposts=-1');

        $contact_forms[''] = __('Please select form', 'editech-core');
        if ($cf7) {
            foreach ($cf7 as $cform) {
                $contact_forms[$cform->post_name] = $cform->post_title;
            }
        } else {
            $contact_forms[0] = __('No contact forms found', 'editech-core');
        }

        $this->add_control(
            'contact_slug',
            [
                'label'   => __('Select contact form', 'editech-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => '',
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Placeholder Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Button Submit', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'contact_slug!' => '',
                ]
