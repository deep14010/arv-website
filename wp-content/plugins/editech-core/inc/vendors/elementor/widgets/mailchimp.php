...
class OSF_Elementor_Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return __( 'MailChimp Sign-Up Form', 'editech-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'hide_text',
			[
				'label'        => __( 'Hide Text', 'editech-core' ),
		...
		$this->add_control(
			'hide_icon',
			[
				'label'        => __( 'Hide Icon', 'editech-core' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_off'    => __( 'Off', 'editech-core' ),
				'label_on'     => __( 'On', 'editech-core' ),
				'default'      => '',
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'row',
				'options'   => [
					'row'    => __( 'Horizontal', 'editech-core' ),
					'column' => __( 'Vertical', 'editech-core' ),
				],
		...
		$this->add_responsive_control(
			'width_form',
			[
				'label'      => __( 'Form Width', 'editech-core' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'%' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'default',
				'options'      => [
					'default'           => __( 'Deafault', 'editech-core' ),
