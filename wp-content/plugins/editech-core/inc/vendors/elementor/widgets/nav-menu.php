...
class OSF_Elementor_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Nav Menu', 'editech-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'type_menu',
				'options' => [
					'type_menu'     => __( 'Menu', 'editech-core' ),
					'type_location' => __( 'Location', 'editech-core' ),
				],
			]
		);
		...
		$this->add_control(
			'location',
			[
				'label'     => __( 'Location', 'editech-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'condition' => [
					'type_field_menu' => 'type_location'
				],
				'options'   => wp_parse_args( get_registered_nav_menus(), [ '' => esc_html__( '', 'editech-core' ) ] ),
				'separator' => 'after',
			]
		);
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				...
				[
					...
					'separator'    => 'after',
					'description'  => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'editech-core' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'editech-core' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator'       => 'after',
		...
		$this->add_control(
			'pointer',
			[
				'label'   => __( 'Pointer', 'editech-core' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none'        => __( 'None', 'editech-core' ),
					'underline'   => __( 'Underline', 'editech-core' ),
					'overline'    => __( 'Overline', 'editech-core' ),
					'double-line' => __( 'Double Line', 'editech-core' ),
					'framed'      => __( 'Framed', 'editech-core' ),
					'text'        => __( 'Text', 'editech-core' ),
					'dot'         => __( 'Dot', 'editech-core' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			'dot_width',
			[
				'label'     => __( 'Dot Width', 'editech-core' ),
		...
		$this->add_responsive_control(
			'dot_height',
			[
				'label'     => __( 'Dot Height', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'dot_border_radius',
			[
				'label'      => __( 'Dot Radius', 'editech-core' ),
		...
		$this->add_control(
			'indicator',
			[
				'label'        => __( 'Submenu Indicator', 'editech-core' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'angle',
				'options'      => [
					'none'          => __( 'None', 'editech-core' ),
					'classic'       => __( 'Classic', 'editech-core' ),
					'chevron'       => __( 'Chevron', 'editech-core' ),
					'chevron_right' => __( 'Chevron Right', 'editech-core' ),
					'angle'         => __( 'Angle', 'editech-core' ),
					'angle_right'   => __( 'Angle Right', 'editech-core' ),
					'plus'          => __( 'Plus', 'editech-core' ),
				],
		...
		$this->add_responsive_control(
			'indicator_fsize',
			[
				'label'     => __( 'Indicator Font Size', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 10,
		...
		$this->add_responsive_control(
			'indicator_size',
			[
				'label'     => __( 'Indicator Size', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 10,
		...
		$this->add_responsive_control(
			'indicator_padding',
			[
				'label'     => __( 'Indicator Spacing', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 10,
		...
		$this->add_control(
			'enable_divider_menu',
			[
				'label'     => __( 'Enable Divider', 'editech-core' ),
		...
		$this->add_responsive_control(
			'divider_width',
			[
				'label'     => __( 'Divider Width', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 10,
		...
		$this->add_responsive_control(
			'divider_height',
			[
				'label'     => __( 'Divider Height', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 10,
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Divider Radius', 'editech-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'subMenusMinWidth',
			[
				'label'     => __( 'Min width Submenu(px)', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 50,
		...
		$this->add_responsive_control(
			'subMenusMaxWidth',
			[
				'label'   => __( 'Max width Submenu(px)', 'editech-core' ),
				'type'    => Controls_Manager::SLIDER,
				'range'   => [
					'px' => [
						'min' => 100,
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Mobile Dropdown', 'editech-core' ),
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Enable Mobile Menu', 'editech-core' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'dropdown',
				'options'   => [
					'dropdown' => __( 'Dropdown', 'editech-core' ),
					'canvas'   => __( 'Canvas', 'editech-core' ),
					'popup'    => __( 'Popup', 'editech-core' ),
				],
				'condition' => [
		...
		$this->add_control(
			'dropdown',
			[
				'label'        => __( 'Breakpoint', 'editech-core' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'tablet',
				'options'      => [
					'mobile' => __( 'Mobile (767px >)', 'editech-core' ),
					'tablet' => __( 'Tablet (1023px >)', 'editech-core' ),
					'destop' => __( 'Destop', 'editech-core' ),
				],
		...
		$this->add_control(
			'full_width',
			[
				'label'              => __( 'Full Width', 'editech-core' ),
				'type'               => Controls_Manager::SWITCHER,
				'description'        => __( 'Stretch the dropdown of the menu to full width.', 'editech-core' ),
		...
		$this->add_responsive_control(
			'width_dropdown',
			[
				'label'      => __( 'Width Dropdown', 'editech-core' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'toggle',
			[
				'label'              => __( 'Toggle Button', 'editech-core' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'burger',
				'options'            => [
					''       => __( 'None', 'editech-core' ),
					'burger' => __( 'Hamburger', 'editech-core' ),
				],
		...
		$this->add_responsive_control(
			'toggle_align',
			[
				'label'        => __( 'Toggle Align', 'editech-core' ),
				'type'         => Controls_Manager::CHOOSE,
				'default'      => 'left',
				'options'      => [
					'left'   => [
		...
		$this->add_control(
			'menu-toggle-title',
			[
				'label'   => __( 'Title Toggle', 'editech-core' ),
				'default' => 'Menu',
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'editech-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Mega Menu', 'editech-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'color_sub_arrow',
			[
				'label'     => __( 'Sub Arrow Color', 'editech-core' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'bgcolor_sub_arrow',
			[
				'label'     => __( 'Sub Arrow Background Color', 'editech-core' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Pointer Color', 'editech-core' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'pointer_height',
			[
				'label'     => __( 'Pointer Height', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Horizontal Padding', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Vertical Padding', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 50,
		...
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Dropdown', 'editech-core' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->add_control(
			...
			[
				'raw'             => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'editech-core' ),
				'type'            => Controls_Manager::RAW_HTML,
		...
		$this->add_control(
			'dropdown_box',
			[
				'label'     => __( 'Dropdown Box', 'editech-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Distance', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => - 100,
		...
		$this->add_control(
			'dropdown_item',
			[
				'label'     => __( 'Dropdown Item', 'editech-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'show_line',
			[
				'label'     => __( 'Show line hover', 'editech-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'selectors' => [
