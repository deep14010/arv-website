...
class OSF_Elementor_Header_Group extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Header Group', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => __('Show wishlist', 'editech-core'),
        ...
        $this->add_control(
            'show_search',
            [
                'label' => __('Show search form', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_account',
            [
                'label' => __('Show account', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_cart',
            [
                'label' => __('Show cart', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            'wishlist_config',
            [
                'label'     => __('WooCommerce Wishlist', 'editech-core'),
                'condition' => [
                    'show_wishlist!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_subtotal',
            [
                'label' => __('Show Total', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Wishlist', 'editech-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'search_config',
            [
                'label'     => __('Search Form', 'editech-core'),
                'condition' => [
                    'show_search!' => '',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => 'full_screen',
                'options'            => [
                    'classic'     => __('Classic', 'editech-core'),
                    'minimal'     => __('Minimal', 'editech-core'),
                    'full_screen' => __('Full Screen', 'editech-core'),
                ],
        ...
        $this->add_control(
            'placeholder',
            [
                'label'     => __('Placeholder', 'editech-core'),
                'type'      => Controls_Manager::TEXT,
                'separator' => 'before',
                'default'   => __('Search', 'editech-core') . '...',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'icon',
                'options'      => [
                    'icon' => __('Icon', 'editech-core'),
                    'text' => __('Text', 'editech-core'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    'search' => [
                        'title' => __('Search', 'editech-core'),
                        'icon'  => 'opal-icon-search',
                    ],
                    'arrow'  => [
                        'title' => __('Arrow', 'editech-core'),
        ...
        $this->add_control(
            'show_icon_account',
            [
                'label' => __('Show Icon', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Text', 'editech-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => __('Account', 'editech-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'cart_content',
            [
                'label'     => __('WooCommerce Cart', 'editech-core'),
                'condition' => [
                    'show_cart!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_items',
            [
                'label' => __('Show Count Text', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_amount',
            [
                'label' => __('Show Amount', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_count',
            [
                'label' => __('Show Count', 'editech-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Wishlist Style', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Hover Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Hover Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label'     => __('Search Form Style', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Overlay Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Account Style', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_account' => 'yes',
                ],
        ...
        $this->add_control(
            'indicator_style',
            [
                'label'     => __('INDICATOR', 'editech-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'indicator_color',
            [
                'label'     => __('Indicator Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label'     => __('Cart Style', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_cart' => 'yes',
                ],
        ...
        $this->add_control(
            'amount_color',
            [
                'label'     => __('Amount Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('COUNT TEXT', 'editech-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'count_text_color',
            [
                'label'     => __('Count Text Color', 'editech-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="elementor-search-form__container">
                ...
                <div class="w-100 elementor-search-form--full-screen-inner">
                    ...
                    <div class="dialog-lightbox-close-button dialog-close-button">
                        ...
                        <span class="elementor-screen-only"><?php esc_html_e('Close', 'editech-core'); ?></span>
                    </div>
                </div>
            <?php endif ?>
            </div>
            ...
            <a data-toggle="toggle" class="cart-contents header-button" href="<?php echo esc_url(wc_get_cart_url()); ?>">
                ...
                <?php if (!empty(WC()->cart) && WC()->cart instanceof WC_Cart): ?>
                    ...
                    <?php if ($settings['show_items']): ?>
                        <span class="count-text"><?php echo wp_kses_data(_n("item", "items", WC()->cart->get_cart_contents_count(), "editech-core")); ?></span>
                    <?php endif; ?>
    ...
    protected function render_account() {
        ...
        if (!is_user_logged_in()) {
            $account_text = esc_html__('Sign in / Sign up', 'editech-core');
        } else {
            $account_text = esc_html__('My Account ', 'editech-core');
        }
        ?>
    ...
    protected function render_form_login() { ?>
        ...
        <div class="login-form-head pb-1 mb-3 bb-so-1 bc d-flex align-items-baseline justify-content-between">
            <span class="login-form-title"><?php esc_attr_e('Sign in', 'editech-core') ?></span>
            <span class="pull-right">
                <a class="register-link" href="<?php echo esc_url(wp_registration_url()); ?>"
                   title="<?php esc_attr_e('Register', 'editech-core'); ?>"><?php esc_attr_e('Create an Account', 'editech-core'); ?></a>
            </span>
        </div>
        <form class="opal-login-form-ajax" data-toggle="validator">
            <p>
                <label><?php esc_attr_e('Username or email', 'editech-core'); ?>
                    <span class="required">*</span></label>
                <input name="username" type="text" required placeholder="<?php esc_attr_e('Username', 'editech-core') ?>">
            </p>
            <p>
                <label><?php esc_attr_e('Password', 'editech-core'); ?> <span class="required">*</span></label>
                <input name="password" type="password" required placeholder="<?php esc_attr_e('Password', 'editech-core') ?>">
            </p>
            <button type="submit" data-button-action class="btn btn-primary btn-block w-100 mt-1">
                <span><?php esc_html_e('Login', 'editech-core') ?></span></button>
            <input type="hidden" name="action" value="osf_login">
            <?php wp_nonce_field('ajax-osf-login-nonce', 'security-login'); ?>
        </form>
        <div class="login-form-bottom">
            <a href="<?php echo wp_lostpassword_url(get_permalink()); ?>" class="mt-2 lostpass-link d-inline-block" title="<?php esc_attr_e('Lost your password?', 'editech-core'); ?>"><?php esc_attr_e('Lost your password?', 'editech-core'); ?></a>
        </div>
        <?php
    ...
    protected function render_dashboard() { ?>
        <?php if (has_nav_menu('my-account')) : ?>
            <nav class="social-navigation" role="navigation" aria-label="<?php esc_attr_e('Dashboard', 'editech-core'); ?>">
                <?php
                wp_nav_menu(array(
        ...
        <?php else: ?>
            <ul class="account-dashboard">
                ...
                <?php if (osf_is_woocommerce_activated()): ?>
                    <li>
                        <a href="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>" title="<?php esc_html_e('Dashboard', 'editech-core'); ?>"><?php esc_html_e('Dashboard', 'editech-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('orders')); ?>" title="<?php esc_html_e('Orders', 'editech-core'); ?>"><?php esc_html_e('Orders', 'editech-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('downloads')); ?>" title="<?php esc_html_e('Downloads', 'editech-core'); ?>"><?php esc_html_e('Downloads', 'editech-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('edit-address')); ?>" title="<?php esc_html_e('Edit Address', 'editech-core'); ?>"><?php esc_html_e('Edit Address', 'editech-core'); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(wc_get_account_endpoint_url('edit-account')); ?>" title="<?php esc_html_e('Account Details', 'editech-core'); ?>"><?php esc_html_e('Account Details', 'editech-core'); ?></a>
                    </li>
                <?php else: ?>
                    <li>
                        <a href="<?php echo esc_url(get_dashboard_url(get_current_user_id())); ?>" title="<?php esc_html_e('Dashboard', 'editech-core'); ?>"><?php esc_html_e('Dashboard', 'editech-core'); ?></a>
                    </li>
                <?php endif; ?>
                <li>
                    <a title="<?php esc_html_e('Log out', 'editech-core'); ?>" class="tips" href="<?php echo esc_url(wp_logout_url(home_url())); ?>"><?php esc_html_e('Log Out', 'editech-core'); ?></a>
                </li>
            </ul>
        <?php endif;
