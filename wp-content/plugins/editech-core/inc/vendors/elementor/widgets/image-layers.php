...
class OSF_Elementor_Image_Layers_Widget extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'editech-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label' => esc_html__('Select Content', 'editech-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'editech-core'),
                    'text' => esc_html__('Text Content', 'editech-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label' => esc_html__('Upload Image', 'editech-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label' => esc_html__('Content', 'editech-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Lorem ipsum dolor sit amet', 'editech-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('text_color',
            [
                'label' => esc_html__('Color', 'editech-core'),
        ...
        $repeater->add_control('img_layers_position',
            [
                'label' => esc_html__('Position', 'editech-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'editech-core'),
                    'absolute' => esc_html__('Absolute', 'editech-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label' => esc_html__('Horizontal Offset', 'editech-core'),
                'type' => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'editech-core'),
                'size_units' => ['px', "em", '%'],
                'range' => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label' => esc_html__('Vertical Offset', 'editech-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'editech-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', "em", '%'],
                'range' => [
        ...
        $repeater->add_control('img_layers_link_selection',
            [
                'label' => esc_html__('Link Type', 'editech-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'editech-core'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label' => esc_html__('Degrees', 'editech-core'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'editech-core'),
                'min' => -180,
                'max' => 180,
                'condition' => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label' => esc_html__('Entrance Animation', 'editech-core'),
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label' => esc_html__('Animation Delay', 'editech-core') . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '',
                'min' => 0,
                'step' => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label' => esc_html__('Mousemove Interactivity', 'editech-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'editech-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label' => esc_html__('Interactivity Style', 'editech-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'parallax' => esc_html__('Mouse Parallax', 'editech-core'),
                    'tilt' => esc_html__('Tilt', 'editech-core'),
                ],
                'default' => 'parallax',
                'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label' => esc_html__('Rate', 'editech-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => -10,
                'min' => -20,
                'max' => 20,
                'step' => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'editech-core'),
                'separator' => 'after',
                'label_block' => true,
                'condition' => [
                    'img_layers_mouse' => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label' => esc_html__('z-index', 'editech-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label' => esc_html__('CSS Classes', 'editech-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'editech-core'),
            ]
        );
        ...
        <div id="opal-img-layers-wrapper" class="opal-img-layers-wrapper">
            <ul class="opal-img-layers-list-wrapper list-unstyled">
                ...
                foreach ($settings['img_layers_images_repeater'] as $index => $image) :
                    ...
                    if(!empty($image['img_layers_animation_delay'])) {
                        $this->add_render_attribute($list_item_key, 'data-layer-animation-delay', $image['img_layers_animation_delay']);
                    }
