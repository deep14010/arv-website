...
class OSF_Elementor_Tabs extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Tabs', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => __('Tab Title', 'editech-core'),
                'placeholder' => __('Tab Title', 'editech-core'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'source',
            [
                'label'   => __('Source', 'editech-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'html',
                'options' => [
                    'html'     => __('HTML', 'editech-core'),
                    'template' => __('Template', 'editech-core'),
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => __('Tab Content', 'editech-core'),
                'placeholder' => __('Tab Content', 'editech-core'),
        ...
        $repeater->add_control(
            ...
            [
                'name'        => 'tab_template',
                'label'       => __('Choose Template', 'editech-core'),
                'default'     => 0,
                'type'        => Controls_Manager::SELECT,
                'options'     => $options,
                'types'       => $types,
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Tabs Items', 'editech-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title' => __('Tab #1', 'editech-core'),
                        'tab_html'  => __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                        'source'    => 'html',
                    ],
                    [
                        'tab_title' => __('Tab #2', 'editech-core'),
                        'tab_html'  => __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                        'source'    => 'html',
                    ],
                ],
        ...
        $this->add_control(
            'navigation_width',
            [
                'label'     => __('Navigation Width', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-tabs-wrapper .elementor-tab-title.elementor-active span' => 'color: {{VALUE}};',
                ],
                'global'    => [
