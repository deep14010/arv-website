...
class OSF_Element_Site_Logo extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'editech-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'editech-core' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'editech-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'editech-core' ),
                    'customize' => __( 'Custom Logo', 'editech-core' ),
                ]
            ]
        );
        ...
        $this->add_control(
            'caption_source',
            [
                'label' => __( 'Caption', 'editech-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'none' => __( 'None', 'editech-core' ),
                    'attachment' => __( 'Attachment Caption', 'editech-core' ),
                    'custom' => __( 'Custom Caption', 'editech-core' ),
                ],
                'default' => 'none',
            ]
        );
        ...
        $this->add_control(
            'caption',
            [
                'label' => __( 'Custom Caption', 'editech-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __( 'Enter your image caption', 'editech-core' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'none' => __( 'None', 'editech-core' ),
                    'file' => __( 'Media File', 'editech-core' ),
                    'custom' => __( 'Custom URL', 'editech-core' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'open_lightbox',
            [
                'label' => __( 'Lightbox', 'editech-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __( 'Default', 'editech-core' ),
                    'yes' => __( 'Yes', 'editech-core' ),
                    'no' => __( 'No', 'editech-core' ),
                ],
                'condition' => [
                    'link_to' => 'file',
                ],
