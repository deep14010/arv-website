...
class OSF_Elementor_Counter extends Widget_Counter {
    ...
    public function get_title() {
        return __('Counter', 'editech-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'starting_number',
            [
                'label'   => __('Starting Number', 'editech-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label'   => __('Ending Number', 'editech-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label'       => __('Number Prefix', 'editech-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'editech-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'editech-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'editech-core'),
                    'use_image' => __('Use Image', 'editech-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'editech-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'editech-core'),
                'label_off' => __('Hide', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Separator', 'editech-core'),
                'type'      => Controls_Manager::SELECT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'editech-core'),
                'placeholder' => __('Cool Number', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Description...', 'editech-core'),
            ]
        );
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Content Align', 'editech-core'),
                'type'         => Controls_Manager::CHOOSE,
                'options'      => [
                    'left' => [
                        'title' => __('Left', 'editech-core'),
        ...
        $this->start_controls_section(
            'section_image',
            [
                'label'     => __('Image & SVG', 'editech-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition'  => [
                    'icon_select' => 'use_image',
                    'show_icon'   => 'yes',
