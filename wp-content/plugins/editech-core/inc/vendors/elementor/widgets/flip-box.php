...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'editech-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'editech-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'editech-core' ) ] );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'This is the sub title', 'editech-core' ),
...
//				'show_label' => false,
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'editech-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'editech-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'editech-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'editech-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'editech-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'editech-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'editech-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'editech-core' ),
					'right' => __( 'Right', 'editech-core' ),
					'up' => __( 'Up', 'editech-core' ),
					'down' => __( 'Down', 'editech-core' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'editech-core' ),
