...
class OSF_Widget_Image_Shape extends Widget_Base {
	...
	public function get_title() {
		return __( 'Image Shape', 'editech-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => __( 'Image Box', 'editech-core' ),
			]
		);
		...
		$this->add_control(
			'media_type',
			[
				'label'   => __( 'Media Type', 'editech-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'image' => __( 'Image', 'editech-core' ),
					'svg'   => __( 'SVG Code', 'editech-core' ),
				],
				'default' => 'image',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Hover Wrapper Animation', 'editech-core' ),
		...
		$this->add_control(
			'link_download',
			[
				'label' => __( 'Download Link ?', 'editech-core' ),
...
//        control button
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Animation Background', 'editech-core' ),
			]
		);
		...
		$this->add_control(
			'hover_animation_bg',
			[
				'label' => __( 'Enable Animation', 'editech-core' ),
				'type'  => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'0' => __( 'Style 1', 'editech-core' ),
					'1' => __( 'Style 2', 'editech-core' ),
					'2' => __( 'Style 3', 'editech-core' ),
				],
				'default'   => '1',
				'condition' => [
		...
		$this->add_control( 'bg_animation_duration',
			[
				'label'     => esc_html__( 'Duration', 'editech-core' ),
				'type'      => Controls_Manager::NUMBER,
				'title'     => esc_html__( 'Set the animation duration in milliseconds, default is 1200', 'editech-core' ),
				'default'   => 1200,
				'condition' => [
					'hover_animation_bg' => 'yes'
				]
		...
		$this->add_control( 'bg_animation_elasticity',
			[
				'label'     => esc_html__( 'Elasticity', 'editech-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 400,
				'condition' => [
					'hover_animation_bg' => 'yes'
...
//        end control button
		...
		$this->add_control(
			'title_color_hover',
			[
				'label'     => __( 'Color Hover (Wrapper)', 'editech-core' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Transition Duration', 'editech-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 3,
