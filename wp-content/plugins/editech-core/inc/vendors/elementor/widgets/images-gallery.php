...
class OSF_Elementor_Image_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Image Gallery', 'editech-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => __('Image Gallery', 'editech-core'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => __('Filter Title', 'editech-core'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => __('Add Images', 'editech-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => __('Gallery 1', 'editech-core'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Infinite Scroll', 'editech-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __('Off', 'editech-core'),
                'label_on'  => __('On', 'editech-core'),
            ]
...
//                'exclude'   => ['custom'],
        ...
        $this->add_control(
            ...
            [
                'label'      => __('Image Spacing', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'show_label' => false,
                'range'      => [
                    'px' => [
