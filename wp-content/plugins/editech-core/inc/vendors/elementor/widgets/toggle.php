    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => __('Toggle Title', 'editech-core'),
                'label_block' => true,
                'dynamic'     => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => __('Toggle Content', 'editech-core'),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Toggle Items', 'editech-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Toggle #1', 'editech-core'),
                    ...
                    [
                        'tab_title'   => __('Toggle #2', 'editech-core'),
                        'tab_content' => __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'editech-core'),
                    ],
                ],
