...
class OSF_Widget_Icon_List extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Icon List', 'editech-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_icon',
            [
                'label' => __( 'Icon List', 'editech-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'traditional' => [
                        'title' => __( 'Default', 'editech-core' ),
                        'icon' => 'eicon-editor-list-ul',
                    ],
                    'inline' => [
                        'title' => __( 'Inline', 'editech-core' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'List Item', 'editech-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'text' => __( 'List Item #1', 'editech-core' ),
                        'icon' => 'fa fa-check',
                    ],
                    [
                        'text' => __( 'List Item #2', 'editech-core' ),
                        'icon' => 'fa fa-times',
                    ],
                    [
                        'text' => __( 'List Item #3', 'editech-core' ),
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => __( 'Text Indent', 'editech-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'text_underline',
            [
                'label' => __( 'Show Underline', 'editech-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Underline spacing', 'editech-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -10,
