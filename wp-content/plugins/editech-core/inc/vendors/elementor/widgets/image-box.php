...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'editech-core');
    }
...
//        control button
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your button text', 'editech-core'),
                'label_block' => true,
                'default'     => 'Button',
            ]
        );
...
//        end control button
        ...
        $this->add_responsive_control(
            'image_wrapper',
            [
                'label'      => __('Wrapper Size', 'editech-core'),
        ...
        $this->add_responsive_control(
            'image_align',
            [
                'label'     => __('Image Alignment', 'editech-core'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => __('Left', 'editech-core'),
        ...
        $this->add_control(
            'image_hover_scale',
            [
                'label'     => __('Hover Scale', 'editech-core'),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'btn_text_spacing',
            [
                'label'     => __('Spacing Text', 'editech-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
