...
class OSF_Elementor_Parallax {
    ...
    public function register_controls($element, $args) {
        ...
        $element->start_controls_section(
            ...
            [
                'label' => __('Multi Parallax ', 'editech-core'),
                'tab'   => Controls_Manager::TAB_LAYOUT,
            ]
        );
        $element->add_control('osf_section_parallax_switcher',
            [
                'label' => __('Enable Parallax', 'editech-core'),
        ...
        $repeater->add_control(
            ...
            [
                'label'   => __('Parallax Type', 'editech-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => __('Image', 'editech-core'),
                    'svg'   => __('Svg', 'editech-core'),
                    'svg'   => __('Opal Style', 'editech-core'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label'   => __('Opal Style Color', 'editech-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
        ...
        $repeater->add_control(
            ...
            [
                'label'     => __('Custom Color', 'editech-core'),
        ...
        $repeater->add_control(
            ...
            [
                'label'      => __('Position h', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    '%'  => [
                        'min' => 0,
        ...
        $repeater->add_control(
            ...
            [
                'label'      => __('Position v', 'editech-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    '%'  => [
                        'min' => 0,
        ...
        $repeater->add_control(
            ...
            [
                'label'       => __('Z-Index', 'editech-core'),
                'type'        => Controls_Manager::NUMBER,
                'default'     => 1,
                'description' => __('Choose z-index for the parallax layer, default: 3', 'editech-core'),
            ]
        );
        $repeater->add_control(
            'osf_section_parallax_mouse',
            [
                'label'       => __('Mousemove Parallax', 'editech-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => __('Enable or disable mousemove interaction', 'editech-core'),
            ]
        );
        $repeater->add_control(
            'osf_section_parallax_rate',
            [
                'label'   => __('Rate', 'editech-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => -10,
                'min'     => -20,
                'max'     => 20,
        ...
        $element->add_control(
            ...
            [
                'label'     => __('Parallax Items', 'editech-core'),
