...
class OSF_Import {
    ...
    public function import_file_base() {
        ...
        $import    = array(
            ...
            'local_import_file' => trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy-data/content.xml',
            ...
            'slug'              => '1',
            'customizer'        => trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy-data/customizer.json',
            'elementor'         => trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy-data/elementor.json',
            'settings'          => trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy-data/settings.json',
        );
        $imports[] = $import;
    ...
    public function import_files() {
        ...
        foreach ($this->config as $key => $item) {
            $import = array(
                ...
                'slug'                     => $key,
                'settings'                 => trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy_data/settings.json',
            );
            if (isset($item['xml'])) {
                $import['local_import_file'] = trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'dummy-data/' . $item['xml'];
            }
    ...
    private function init_data() {
        $this->config = array(
            '1'=> [
                'name' => 'Home 1',
                'screenshot' => 'http://source.wpopal.com/editech/dummy_data/editech/home-1.jpg',
                'rev_sliders' => [
                    'http://source.wpopal.com/editech/dummy_data/revsliders/home-1/slider-1.zip',
                ],
            ],
            '2'=> [
                'name' => 'Home 2',
                'screenshot' => 'http://source.wpopal.com/editech/dummy_data/editech/home-2.jpg',
                'rev_sliders' => [
                    'http://source.wpopal.com/editech/dummy_data/revsliders/home-2/slider-2.zip',
                ],
                'xml'=>'home-2.xml', 
            ],
            '3'=> [
                'name' => 'Home 3',
                'screenshot' => 'http://source.wpopal.com/editech/dummy_data/editech/home-3.jpg',
                'rev_sliders' => [
                    'http://source.wpopal.com/editech/dummy_data/revsliders/home-3/slider-3.zip',
                ],
                'xml'=>'home-3.xml', 
            ],
            '4'=> [
                'name' => 'Home 4',
                'screenshot' => 'http://source.wpopal.com/editech/dummy_data/editech/home-4.jpg',
                'rev_sliders' => [
                    'http://source.wpopal.com/editech/dummy_data/revsliders/home-4/slider-4.zip',
                ],
                'xml'=>'home-4.xml', 
            ],
            '5'=> [
                'name' => 'Home 5',
                'screenshot' => 'http://source.wpopal.com/editech/dummy_data/editech/home-5.jpg',
                'rev_sliders' => [
                    'http://source.wpopal.com/editech/dummy_data/revsliders/home-5/slider-5.zip',
                ],
                'xml'=>'home-5.xml', 
            ],
        );
    ...
    public function reset_theme_mods() {
        $mods = json_decode(file_get_contents(trailingslashit(EDITECH_CORE_PLUGIN_DIR) . 'reset-theme-mods.json'));
        foreach ($mods as $mod) {
    ...
    private function update_url_elementor() {
        $from          = 'http://source.wpopal.com/editech';
        $to            = site_url();
